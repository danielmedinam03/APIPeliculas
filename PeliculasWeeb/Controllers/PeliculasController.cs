    ...
    public class PeliculasController : Controller
    {
        ...
        public async Task<IActionResult> Create(Pelicula pelicula)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _repository.AddAsync(CT.RutaPeliculasApi, pelicula);
        ...
        public async Task<IActionResult> Update(Pelicula pelicula)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _repository.UpdateAsync(CT.RutaPeliculasApi + pelicula.Id, pelicula);
                return RedirectToAction(nameof(Index));
        ...
        {
            var status = await _repository.DeleteAsync(CT.RutaPeliculasApi, Id);
