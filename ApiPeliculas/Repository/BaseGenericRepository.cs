...
namespace ApiPeliculas.Repository
{
    public abstract class BaseGenericRepository<T> : IBaseGenericRepository<T> where T : class
    {
        ...
        public async Task<List<T>> GenericGetAllAsync(Expression<Func<T, bool>> predicate = null,
                                                ...
                                                Expression<Func<T, T>> selector = null, bool distinct = false)
        {
        ...
        public async Task<bool> ExistGenericAsync(Expression<Func<T, bool>> predicate = null,
                                            Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null)
        {
            if (predicate == null)
        ...
        public async Task<bool> UpdateGenericAsync(T value, bool saveChanges = true,
        ...
        public async Task<bool> DeleteAsync(Expression<Func<T, bool>> predicate = null,
